    ...
    <NextUINavbar isBordered maxWidth="xl" position="sticky">
      <NavbarContent className="" justify="start">
        ...
        <div className="hidden sm:flex gap-4 justify- ml-2">
          <NavbarContent>
            <NavbarItem>
              <Button onClick={() => navigate("/users")} variant="link">
                Usuarios
              </Button>
            </NavbarItem>
            <NavbarItem className="gap-2">
              <Button onClick={() => navigate("/branches")} variant="link">
                Sucursales
              </Button>
            </NavbarItem>
            <NavbarItem>
              <Button onClick={() => navigate("/provider")} variant="link">
                Proveedores
              </Button>
            </NavbarItem>
            <NavbarItem>
              <Button onClick={() => navigate("/assets")} variant="link">
                Activos
              </Button>
            </NavbarItem>
            <NavbarItem>
              <Button onClick={() => navigate("/usersMb")} variant="link">
                Usuarios MB
              </Button>
            </NavbarItem>
            <NavbarItem>
              <Button onClick={() => navigate("/migrations")} variant="link">
                Migraciones
              </Button>
            </NavbarItem>
          </NavbarContent>
